...
CREATE TABLE IF NOT EXISTS `report`  (
  ...
  `sql` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'sql配置',
  `condition` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '条件模板',
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '内容模板',
  `is_active` tinyint(1) NULL DEFAULT 1 COMMENT '是否激活',
  `visit_count` int NULL DEFAULT 0 COMMENT '使用次数',
  `fcu` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `lcu` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人',
  `fcd` timestamp(3) NULL DEFAULT NULL COMMENT '创建时间',
  `lcd` timestamp(3) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_type`(`type`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表模版表';
...
CREATE TABLE IF NOT EXISTS `report_auth`  (
  ...
  INDEX `idx_uuid`(`auth_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表模版授权表';
...
CREATE TABLE IF NOT EXISTS `report_blackwhitelist`  (
  ...
  `item_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '表名或字段名，支持*作为模糊匹配，如果是字段名且带.，代表精确管理某张表的字段',
  `item_type` enum('table','column') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '对象类型',
  `type` enum('whitelist','blacklist') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '先根据白名单开放，再根据黑名单排除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk`(`item_name`, `item_type`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表黑白名单表';

-- ----------------------------
-- Table structure for report_china_country
-- ----------------------------
CREATE TABLE IF NOT EXISTS `report_china_country`  (
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '国家名称',
  `adcode` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '区号',
  `level` enum('district') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '水平',
  `x` float NULL DEFAULT NULL COMMENT 'x轴',
  `y` float NULL DEFAULT NULL COMMENT 'y轴',
  PRIMARY KEY (`adcode`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表国家配置';
...
CREATE TABLE IF NOT EXISTS `report_param`  (
  ...
  `type` enum('forminput','formselect','formcheckbox','formradio','formdate','formdaterange','formselects') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '类型',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表模版参数表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表发送接收人表';
...
CREATE TABLE IF NOT EXISTS `report_send_job`  (
  ...
  `email_content` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '邮件正文',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表发送计划表';
...
CREATE TABLE IF NOT EXISTS `report_send_job_relation`  (
  `report_send_job_id` bigint NOT NULL COMMENT '报表发送计划ID',
  `report_id` bigint NOT NULL COMMENT '报表ID',
  `condition` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '条件',
  `config` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '配置',
  `sort` int NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`report_send_job_id`, `report_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表发送计划-报表关联表';
...
CREATE TABLE IF NOT EXISTS `report_statement`  (
  ...
  `config` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '画布额外配置',
  `widget_list` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '组件列表,json数组格式',
  `width` int NULL DEFAULT NULL COMMENT '宽度',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表配置';
...
CREATE TABLE IF NOT EXISTS `reportinstance`  (
  `id` bigint NOT NULL COMMENT 'id',
  `report_id` bigint NULL DEFAULT NULL COMMENT '报表id',
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '报表名称',
  `visit_count` int NULL DEFAULT NULL COMMENT '浏览次数',
  `is_active` tinyint(1) NULL DEFAULT NULL COMMENT '是否激活',
  `config` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '配置json格式',
  `fcu` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `lcu` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人',
  `fcd` timestamp(3) NULL DEFAULT NULL COMMENT '修改时间',
  `lcd` timestamp(3) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表实例表';
...
CREATE TABLE IF NOT EXISTS `reportinstance_auth`  (
  ...
  INDEX `idx_uuid`(`auth_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表实例授权表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报表实例中含有的表格列表';